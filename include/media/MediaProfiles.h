...
enum camcorder_quality {
    ...
    // psw0523 add
    CAMCORDER_QUALITY_UXGA = 8, // 1600x1200
    CAMCORDER_QUALITY_VGA = 9,  // 640x480
    CAMCORDER_QUALITY_SVGA = 10,  // 800x600
    CAMCORDER_QUALITY_LIST_END = 10,
    // end of psw0523
    ...
    // psw0523 add
    CAMCORDER_QUALITY_TIME_LAPSE_UXGA = 1008,
    CAMCORDER_QUALITY_TIME_LAPSE_VGA  = 1009,
    CAMCORDER_QUALITY_TIME_LAPSE_SVGA  = 1010,
